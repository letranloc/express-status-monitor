...
*/
/* global Chart, location, document, port, socketPath, parseInt, io, socketNamespace */
...
var socket = io(location.protocol + '//' + location.hostname + ':' + (port || location.port) + (socketNamespace || ''), {
    path: socketPath,
